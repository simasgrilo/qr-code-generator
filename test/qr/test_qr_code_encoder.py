...
class TestQRCodeEncoder(unittest.TestCase):
    ...
    def test_encode_alphanumeric(self):
        ...
        self.assertEqual(result, b'00100000001010011100111011100111001000010')
    ...
    def test_encode_string_per_iso_standards(self):
        ...
        self.assertEqual(result, b'')
    def test_encode_data_version_4_level_l(self):
        ...
        self.assertEqual(result, bytes(('00100000010110110000101101111000110100010111001'
                                        '01101110001001101010000110100000011101100000100'
                                        '01111011000001000111101100000100011110110000010'
                                        '00111101100000100011110110000010001111011000001'
                                        '00011110110000010001111011000001000111101100000'
                                        '10001111011000001000111101100000100011110110000'
                                        '01000111101100000100011110110000010001111011000'
                                        '00100011110110000010001111011000001000111101100'
                                        '00010001111011000001000111101100000100011110110'
                                        '00001000111101100000100011110110000010001111011'
                                        '00000100011110110000010001111011000001000111101'
                                        '10000010001111011000001000111101100000100011110'
                                        '11000001000111101100000100011110110000010001111'
                                        '01100000100011110110000010001001000101110111101'
                                        '01110011001101111000111001111011101101100011010'
                                        '10001110110011111010100110001110011001011010100'
                                        '1110101010110100001011110001101010010101101011100000000'), encoding='utf-8'))
...
class TestQRCodeEncoderVer1(unittest.TestCase):
    ...
    def test_encode_data_version_1_level_m_value(self):
        ...
        qr = self._encoder
        result = qr.generate_blocks(qr.encode_input("HELLO WORLD"))
        self.assertEqual(result, bytes(('001000000101101100001011011110001101000'
                                        '101110010110111000100110101000011010000'
                                        '001110110000010001111011000001000111101'
                                        '100000100011100010000100011001001110111'
                                        '011111101011110101111110011111100010010'
                                        '1110100010111'), encoding='utf-8'))
