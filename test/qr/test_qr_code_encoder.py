...
class TestQRCodeEncoder(unittest.TestCase):
    ...
    def test_encode_data_version_4_level_l(self):
        ...
        self.assertEqual(result, ('00100000010110110000101101111000110100010'
                                        '11100101101110001001101010000110100000011'
                                        '10110000010001111011000001000111101100000'
                                        '10001111011000001000111101100000100011110'
                                        '11000001000111101100000100011110110000010'
                                        '00111101100000100011110110000010001111011'
                                        '00000100011110110000010001111011000001000'
                                        '11110110000010001111011000001000111101100'
                                        '00010001111011000001000111101100000100011'
                                        '11011000001000111101100000100011110110000'
                                        '01000111101100000100011110110000010001111'
                                        '01100000100011110110000010001111011000001'
                                        '00011110110000010001111011000001000111101'
                                        '100000100011110110000010001111011000001000'
                                        '111101100000100011110110000010001111011000'
                                        '001000111101100000100011110001001010010110'
                                        '110111110100101101011000001101111000101100'
                                        '1110100010011001110100000010101001100110111'
                                        '011111000011101101100001101110110101010001110101011011100000000'))
class TestQRCodeEncoderVer1(unittest.TestCase):
    ...
    def test_encode_data_version_1_level_m_value(self):
        ...
        qr = self._encoder
        result = qr.generate_blocks(qr.encode_input("HELLO WORLD"))
        self.assertEqual(result, ('001000000101101100001011011110001101'
                                    '000101110010110111000100110101000011'
                                    '010000001110110000010001111011000001'
                                    '000111101100000100011100010000100011'
                                    '001001110111011111101011110101111110'
                                    '0111111000100101110100010111'))
